...
library(cutpointr)
tpr <- tpr(c(9,4,5), c(11,16,15))
fpr <- fpr(c(12,9,5), c(168,171,175))
tnr <-tnr(c(12,9,5), c(168,171,175))
fnr <- fnr(c(9,4,5), c(11,16,15))
models.summary <- data.frame(Model = c("gLinear.Model.06","Decision Tree","Random Forest"), TPR = tpr,FPR = fpr,TNR = tnr,FNR = fnr)
models.summary
...
```{r}
library(performance)
compare_performance(gLinear.Model.05,gLinear.Model.06, rank = TRUE)
```
